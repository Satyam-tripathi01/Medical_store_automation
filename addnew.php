...
if (isset($_POST['saveProduct'])) {
  echo "price: ".$_POST['price'].":".$_POST['stocks'];
if ($con->query("insert into inventeries (catId,supplier,name,unit,price,stocks,description,company) values ('$_POST[catId]','$_POST[supplier]','$_POST[name]','$_POST[unit]','$_POST[price]','$_POST[stocks]','$_POST[discription]','$_POST[company]')")) {
  $notice ="<div class='alert alert-success'>Successfully Saved</div>";
}
else{
    ...
    <div style="width: 55%;margin: auto;padding: 22px;" class="well well-sm center">
      ...
      <form method="POST">
         <div class="form-group">
          ...
          <div class="form-group">
            <label for="some" class="col-form-label">Types of Medicine/Product</label>
          ...
          <div class="form-group">
            <label for="some" class="col-form-label">Stocks</label>
            <input type="number" name="stocks"  class="form-control" id="some" required>
          </div>
          <div class="form-group">
          ...
          <textarea class="form-control" name="discription" placeholder="Write some discription"></textarea> 
          </div>
          <div class="center">
