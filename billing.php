...
<div class="account" style="display: none;">
  ...
  if (isset($_POST['updateBill'])) 
  {
    ...
    $sel= $con->query("SELECT stocks FROM inventeries  WHERE id ='$id'");
    while($row = mysqli_fetch_array($sel))
    { 
      $s = $row['stocks'] ;
      $s =  $s-$qty ;
      echo "balane: ".$s;
      $con->query("UPDATE inventeries SET stocks= $s WHERE id = '$id'");
      echo $row['stocks'];
    }
  ...
  <tr>
    ...
    <td><button class="btn btn-sm btn-primary btn-block" data-toggle="modal" data-target="#billOut"  name='stocks_update'>View Bill</button></td>
  </tr>
</table>
  </div>
</div>
