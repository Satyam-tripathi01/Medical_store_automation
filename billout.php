...
<body style="background: #ECF0F5;padding:0;margin:0">
  ...
  <div class="content2">
    ...
    <div class="well well-sm" style="width: 77%;margin: auto;">
      ...
      <tr>
          <th>Bill no</th>
          <td><?php echo uniqid() ?></th>
          <th>Medical Store Contact No :</th>
          <td><?php echo '8299849284' ?></th>
        </tr>
        <tr>
  ...
  <tr>
    <td colspan="3" style="text-align: right;">Discount <?php echo $_POST['discount']; ?>%</td><th style="border-bottom: 1px solid blue;"><?php echo (($total*$_POST['discount'])/100) ; ?></th>
  </tr>
  <tr>
    <td colspan="3" style="text-align: right;border-right: 1px solid blue">Net Total</td><th style="border: 1px solid blue;"><?php echo $total-(($total*$_POST['discount'])/100); ?></th>
  </tr>
  <tr>
